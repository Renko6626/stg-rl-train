// th06_s7_w15 —— 东方红魔乡 Stage 7(Extra) 道中 第 15 波
// 原文：ecldata7 timeline 帧 6853–6973（Sub10–Sub14 随机位置弹幕组第 4 轮，间隔 30 帧），Extra 档
const TIME_LIMIT: int = 360;
...
// 导演：卡帧 = 120（开场缓冲）+ (原文帧 − 6853)，每 30 帧一只随机 x 小怪
async sub wave() {
    wait(120);
    _ = spawn_enemy((rand(384) - 192) as fx, 64.0fx, 1, 0, 0, 0, sub10());
    wait(30);
    _ = spawn_enemy((rand(384) - 192) as fx, 128.0fx, 1, 0, 0, 0, sub11());
    wait(30);
    _ = spawn_enemy((rand(384) - 192) as fx, 96.0fx, 1, 0, 0, 0, sub12());
    wait(30);
    _ = spawn_enemy((rand(384) - 192) as fx, 64.0fx, 1, 0, 0, 0, sub13());
    wait(30);
    _ = spawn_enemy((rand(384) - 192) as fx, 32.0fx, 1, 0, 0, 0, sub14());
    loop { wait(1); }
}
